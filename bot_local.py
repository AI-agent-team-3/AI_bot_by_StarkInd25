...
def clean_rag_text(text: str) -> str:
    patterns = [r"ignore previous instructions", r"system:", r"assistant:"]
    for p in patterns:
...
def handle_llm_message(message):
    ...
    try:
        # ======================================
        # ⚡ Langfuse span для обработки сообщения
        # ======================================
        with langfuse.start_as_current_observation(
            ...
            # ======================================
            # 🔄 LLM генерация с отдельным span
            # ======================================
            with langfuse.start_as_current_observation(
                name="llm_generation",
                as_type="generation",
